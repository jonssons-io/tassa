<template>
  ...
  <b-navbar toggleable fixed="bottom">
    <b-navbar-brand class="navbar-container" to="/"
      ><span class="logo--text">Tassa</span>
      <img class="logo--img" src="./../assets/LogoCropped.svg" alt="Tassa Logo"
    /></b-navbar-brand>
    ...
    <b-collapse id="navbar-toggle-collapse" is-nav>
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item v-if="loggedInStatus" to="/">Notifikationer</b-nav-item>
        <b-nav-item v-if="loggedInStatus" to="/matchning"
          >Matchningar</b-nav-item
        >
        <b-nav-item to="/om-oss">Om oss</b-nav-item>
        <b-nav-item v-if="!loggedInStatus" to="/logga-in">Logga in</b-nav-item>
        <b-nav-item v-if="loggedInStatus" to="/logga-in">Logga ut</b-nav-item>
      </b-navbar-nav>
    </b-collapse>
  </b-navbar>
</template>
