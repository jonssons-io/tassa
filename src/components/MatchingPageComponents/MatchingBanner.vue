<template>
  <b-container class="bv-example-row">
    ...
    <b-row>
      ...
      <b-col class="B-C"><h6 class="match-list">Ö.Svealand</h6></b-col>
      <b-col class="B-C"
        ><h6 class="match-list">Happy, 2 år, Gand Danois-Hane</h6></b-col
      >
      <div class="w-100"></div>
      ...
      <b-col class="B-C"><h6 class="match-list">Ö.Svealand</h6></b-col>
      <b-col class="B-C"
        ><h6 class="match-list">Bullen, 8 år, Norwhich Terrier-Hane</h6></b-col
      >
      <div class="w-100"></div>
      <b-col class="B-C-A"><h6 class="match-list">H.Persson</h6></b-col>
      <b-col class="B-C-A"><h6 class="match-list">Ö.Svealand</h6></b-col>
      <b-col class="B-C-A"
        ><h6 class="match-list">Lilly, 4 år, Golden Retriver-Tik</h6></b-col
      >
    </b-row>
  </b-container>
</template>
